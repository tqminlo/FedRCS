...
if __name__ == "__main__":
    ...
    parser.add_argument('--strategy', default="FedAvg", type=str, help='strategy FL')
    parser.add_argument('--cs_method', default="Random", type=str, help='strategy Client Selection')
